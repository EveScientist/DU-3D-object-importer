...
- **tests/dep25_sphere_hires.blueprint** (2026-07-18) — DEPLOYMENT 25: HIGH-RES sphere (M, grid 143 = 4x the old default via true BUILD=vsz*4 resolution). 1.5M voxels, 149 records, 737KB. Emitter now numpy-vectorized + per-chunk bucketed (72s->11s emit at grid128). AWAITING DEPLOY (shows sharper surface vs dep23b).
