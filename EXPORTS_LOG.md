...
- **DEPLOYMENT 24 (dep24_half_A/B) rebuilt** (2026-07-18): material-ownership LOD fix closes the 1-voxel seam gap. Half A owns x-cells 113..127, half B 0..14; when core B is grid-aligned +1 core (+X), seam gap = 0, combined = clean smooth sphere (13802 vox, no seam dip). AWAITING DEPLOY.
