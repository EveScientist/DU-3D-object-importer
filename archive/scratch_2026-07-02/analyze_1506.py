...
main = "+bYU+6UJAAAAAAAA9wIToLgnBgAAAJ4zgegJAAAAPwQAFyMEABdABAAXIAQALwD/AgAIb9MBAgAAIQUAeB/zjAB4ARgBD5EA/xAPYAIJDwIA3R92bAMAn+YBAX5+fgEAIAgA1B/P6ADUBNABD/AA//+/D7QF3Q8CAAmAdgIAAADHaGl5CfANAERlYnVnMQAAAaUCsMsAAAAAaGNDYXJib24CAQ=="
...
print("mat_byte_pos = groups_start - 20 =", gA - 20)

# Quadratic predictions (fit from Ncols=1,2,3)
Ncols = 4
pred_marker_span = 5*Ncols*29
pred_groups_total = (Ncols+1)*240
pred_lme = pos1 + pred_marker_span
pred_scan_len = -2*Ncols**2 + 375*Ncols + 893
pred_groups_start = -1*Ncols**2 + 140*Ncols + 351
pred_mat_byte_pos = pred_groups_start - 20
pred_gap1 = pred_groups_start - pred_lme
pred_gap2 = pred_scan_len - (pred_groups_start + pred_groups_total)

print()
print("QUADRATIC PREDICTIONS for Ncols=4:")
print(f"  marker_span={pred_marker_span} last_marker_end={pred_lme} groups_total={pred_groups_total}")
print(f"  scan_len={pred_scan_len} groups_start={pred_groups_start} mat_byte_pos={pred_mat_byte_pos}")
print(f"  gap1={pred_gap1} gap2={pred_gap2}")
