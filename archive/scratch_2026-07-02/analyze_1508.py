...
main = "+bYU+xILAAAAAAAA9wIToLgnBgAAAJ4zgegJAAAAPwQAFyMEABdABAAXIAQALwD/AgAIb9MBAgAAIQUAeB/zjAB4ARgBD5EA/6EP8QIJDwIA0x+t8wMAn+YBAX5+fgEAIAgA1B/P6ADUBNABD/AA////sA+aBtMPAgAJgK0CAAAAx2hp5grwDQBEZWJ1ZzEAAAGlArDLAAAAAGhjQ2FyYm9uAgE="
...
# Linear predictions (Ncols>=2 formula)
Ncols = 5
pred_marker_span = 145*Ncols
pred_lme = pos1 + pred_marker_span
pred_groups_total = (Ncols+1)*240
pred_gap1 = 328 - 10*Ncols
pred_gap2 = 308 - 10*Ncols
pred_groups_start = 357 + 135*Ncols
pred_mat_byte_pos = 337 + 135*Ncols
pred_scan_len = 905 + 365*Ncols

print()
print("LINEAR PREDICTIONS for Ncols=5:")
...
print(f"  groups_start={pred_groups_start} mat_byte_pos={pred_mat_byte_pos} scan_len={pred_scan_len}")
